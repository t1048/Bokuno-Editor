...
const markdownHighlightStyleLight = HighlightStyle.define([
  // 見出し
  { tag: tags.heading1, color: '#0284c7', fontWeight: 'bold' },
  { tag: tags.heading2, color: '#0284c7', fontWeight: 'bold' },
  { tag: tags.heading3, color: '#0284c7', fontWeight: 'bold' },
  { tag: tags.heading4, color: '#0284c7', fontWeight: 'bold' },
  { tag: tags.heading5, color: '#0284c7', fontWeight: 'bold' },
  { tag: tags.heading6, color: '#0284c7', fontWeight: 'bold' },
  ...
  // インラインコード
  { tag: tags.monospace, borderRadius: '3px' },
...
const markdownHighlightStyleDark = HighlightStyle.define([
  // 見出し
  { tag: tags.heading1, color: '#38bdf8', fontWeight: 'bold' },
  { tag: tags.heading2, color: '#38bdf8', fontWeight: 'bold' },
  { tag: tags.heading3, color: '#38bdf8', fontWeight: 'bold' },
  { tag: tags.heading4, color: '#38bdf8', fontWeight: 'bold' },
  { tag: tags.heading5, color: '#38bdf8', fontWeight: 'bold' },
  { tag: tags.heading6, color: '#38bdf8', fontWeight: 'bold' },
